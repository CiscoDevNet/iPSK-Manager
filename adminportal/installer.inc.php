...
SQL;
	...
	$sqlTrigger[0] = <<< SQL
CREATE DEFINER=`{$_SESSION['dbusername']}`@`%` TRIGGER `lastupdate_before_update_trigger` BEFORE UPDATE ON `endpoints` FOR EACH ROW BEGIN
