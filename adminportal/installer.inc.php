...
BEGIN
	...
	ELSE
	  IF EXISTS (SELECT * FROM endpoints WHERE endpoints.macAddress = @formattedMAC) THEN
		SET result=0;
		SELECT fullName,emailAddress,createdBy,description,expirationDate,accountExpired,pskValue, RIGHT(pskValue, LENGTH(pskValue) - 4) as pskValuePlain FROM endpoints WHERE endpoints.macAddress = @formattedMAC;
	  ELSE
		SET result=1;
	  END IF;
	END CASE;
...
SQL;
	...
	$sqlTable[0] = "CREATE TABLE `authorizationTemplates` (`id` int(11) NOT NULL, `authzPolicyName` varchar(255) NOT NULL, `authzPolicyDescription` varchar(255) NOT NULL, `ciscoAVPairPSKMode` varchar(10) NOT NULL DEFAULT 'ascii',  `ciscoAVPairPSK` varchar(68) NOT NULL, `pskLength` int(11) NOT NULL DEFAULT '8', `termLengthSeconds` int(11) NOT NULL, `visible` tinyint(1) NOT NULL DEFAULT '1', `createdBy` varchar(255) NOT NULL, `createdDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=latin1";
	...
	$sqlTable[3] = "CREATE TABLE `endpoints` (`id` int(11) NOT NULL, `macAddress` varchar(17) NOT NULL, `password` varchar(255) NOT NULL, `expirationDate` int(11) NOT NULL, `accountExpired` varchar(5) NOT NULL DEFAULT 'False', `accountEnabled` tinyint(1) NOT NULL DEFAULT '1', `fullName` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `emailAddress` varchar(255) NOT NULL, `pskValue` varchar(68) NOT NULL, `lastAccessed` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `createdBy` varchar(255) NOT NULL, `createdDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=latin1";
	...
	$sqlTable[7] = "CREATE TABLE `ldapServers` (`id` int(11) NOT NULL, `adConnectionName` varchar(255) NOT NULL, `adServer` varchar(255) NOT NULL, `adDomain` varchar(255) NOT NULL, `adUsername` varchar(255) NOT NULL, `adPassword` varchar(255) NOT NULL, `adBaseDN` varchar(255) NOT NULL, `adSecure` int(11) NOT NULL, `createdBy` varchar(255) NOT NULL, `createdDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=latin1";
	...
	$sqlInsert[4] = "INSERT INTO `settings` (`id`, `page`, `settingClass`, `keyName`, `optionIndex`, `value`, `encrypted`) VALUES(1, 'global', 'platform-config', 'system-configured', 0, '1', 0),(2, 'global', 'platform-config', 'logging-level', 0, '1', 0),(3, 'global', 'db-schema', 'version', 0, '3', 0),(4, 'global', 'admin-portal', 'admin-portal-hostname', 0, '', 0),(5, 'global', 'admin-portal', 'admin-portal-strict-hostname', 0, '', 0),(6, 'global', 'admin-portal', 'redirect-on-hostname-match', 0, '1', 0),(7, 'global', 'menu-config', 'adminMenu', 0, '$menuConfig', 0),(8, 'global', 'ise-ers-credentials', 'enabled', 0, '1', 0),(9, 'global', 'ise-ers-credentials', 'ersHost', 0, '', 0),(10, 'global', 'ise-ers-credentials', 'ersUsername', 0, '', 0),(11, 'global', 'ise-ers-credentials', 'ersPassword', 0, '', 1),(12, 'global', 'ise-ers-credentials', 'verify-ssl-peer', 0, '', 0),(13, 'global', 'ise-mnt-credentials', 'enabled', 0, '1', 0),(14, 'global', 'ise-mnt-credentials', 'mntHost', 0, '', 0),(15, 'global', 'ise-mnt-credentials', 'mntUsername', 0, '', 0),(16, 'global', 'ise-mnt-credentials', 'mntPassword', 0, '', 1),(17, 'global', 'ise-mnt-credentials', 'verify-ssl-peer', 0, '', 0)";
