  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="mb-3 input-group-sm fw-bold">
			<label class="fw-bold" for="termLengthSeconds">Extend Association by <span class="text-danger">(from today's date)</span>:</label>
      ...
      <div class="modal-footer">
	    <input type="hidden" id="id" value="{$endpoint['endpointId']}">
 		<a id="extend" href="#" module="extend" role="button" class="btn btn-primary shadow" data-bs-dismiss="modal">Extend</a>
