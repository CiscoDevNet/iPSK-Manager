		...
		if($endpointId){
			...
			if($ipskISEDB->addEndpointAssociation($endpointId, $sanitizedInput['macAddress'], $sanitizedInput['associationGroup'], $_SESSION['logonSID'])){
				...
				if($ipskISEDB->emailEndpointGroup($sanitizedInput['associationGroup'])){
					sendEmail($sanitizedInput['emailAddress'],"iPSK Wi-Fi Credentials","You have been successfully setup to connect to the Wi-Fi Network, please use the following SSID & Passcode:<br>SSID: SecurityLab-iPSK<br>Password: ".$randomPassword."<br><br><br>Thank you!",$smtpSettings);
				}
