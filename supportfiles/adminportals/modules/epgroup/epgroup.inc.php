...
<div class="row menubar">
	<div class="col-3"><a id="addEndpointGroup" module="epgroup" sub-module="add" class="btn btn-primary nav-link custom-link text-white" href="#" role="button">Add Endpoint Group</a></div>
