...
<div class="row menubar">
	<div class="col-2"><a id="addLdapServer" module="ldap" sub-module="add" class="btn btn-primary nav-link custom-link text-white" href="#" role="button">Add LDAP Server</a></div>
