...
<div class="row">
	<div class="col m-3 shadow border border-secondary p-2">
		...
		<label class="fw-bold" for="ersHost">Cisco ISE ERS Integration URL:</label>
		...
		<label class="fw-bold" for="ersUsername">Cisco ISE ERS Integration Username:</label>
		<div class="mb-3 input-group-sm fw-bold">
			<input type="text" class="form-control shadow iseers" id="ersUsername" value="{$iseERSSettings['ersUsername']}">
		</div>
		<label class="fw-bold" for="ersPassword">Cisco ISE ERS Integration Pasword:</label>
		<div class="mb-3 input-group-sm fw-bold">
	...
	<div class="col m-3 shadow border border-secondary p-2">
		...
		<div class="mb-3 input-group-sm fw-bold">
			<label class="fw-bold" for="mntHostPrimary">Cisco ISE MnT Integration URL:</label>
		...
		<div class="mb-3 input-group-sm fw-bold d-none">
			<label class="fw-bold" for="mntHostSecondary">Cisco ISE MnT Integration Secondary Node Hostname:</label>
			<input type="text" class="form-control shadow isemnt" id="mntHostSecondary" value="">
		</div>
		<label class="fw-bold" for="mntUsername">Cisco ISE MnT Integration Username:</label>
		<div class="mb-3 input-group-sm fw-bold">
			<input type="text" class="form-control shadow isemnt" id="mntUsername" value="{$iseMNTSettings['mntUsername']}">
		</div>
		<label class="fw-bold" for="mntPassword">Cisco ISE MnT Integration Pasword:</label>
		<div class="mb-3 input-group-sm fw-bold">
