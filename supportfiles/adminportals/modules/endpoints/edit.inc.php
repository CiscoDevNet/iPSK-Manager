...
HTML;
		...
		print <<<HTML
<!-- Modal -->
<div class="modal fade" id="editEndpoint" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
				<div class="col m-2 shadow p-2 bg-white border border-primary">
					<div class="custom-control custom-checkbox">
						<input type="checkbox" class="custom-control-input checkbox-update" base-value="1" value="0" id="editAssociation">
			...
			<div class="modal-footer">
				...
				<a id="update" href="#" module="endpoints" sub-module="edit" role="button" class="btn btn-primary shadow" data-dismiss="modal">Update</a>
